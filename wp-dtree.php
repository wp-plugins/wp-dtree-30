...
function silpstream_wp_dtree_add2head() {
	...
	$cd = "<script type=\"text/JavaScript\" src=\"" . get_bloginfo('wpurl') . "/wp-content/plugins/wp-dtree/dtree.php?witheff=".$wpdtreeopt['effopt']['effon']."&amp;eff=".$wpdtreeopt['effopt']['efftype']."\" language=\"javascript\"></script>\n";
	$cd .= "<link rel=\"stylesheet\" href=\"" . get_bloginfo('wpurl') . "/wp-content/plugins/wp-dtree/style.php?fontsize=".$wpdtreeopt['cssopt']['fontsize']."&amp;mfontcolor=".$wpdtreeopt['cssopt']['mfontcolor']."&amp;lfontcolor=".$wpdtreeopt['cssopt']['lfontcolor']."&amp;lfontdecor=".$wpdtreeopt['cssopt']['lfontdecor']."&amp;hfontcolor=".$wpdtreeopt['cssopt']['hfontcolor']."&amp;hfontdecor=".$wpdtreeopt['cssopt']['hfontdecor']."\" type=\"text/css\" media=\"screen\" />\n";
	echo $cd;
}
...
<div class='wrap'>
	<p>
	If you found WP-dTree useful, do consider making a <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=chris%40silpstream%2ecom&item_name=WP%2ddTree%20v2%2e2&no_shipping=2&no_note=1&tax=0&currency_code=CAD&bn=PP%2dDonationsBF&charset=UTF%2d8" target="_blank">donation</a> to support it's development. Thank you!<br />
