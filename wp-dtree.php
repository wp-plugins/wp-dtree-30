<?php
	...
	Changes in v3.3.3 (ulfben 2008-07-11)
	...
	*/
	...
	function wp_dtree_set_options(){
		...
		if($oldwpdtreeopt == FALSE || count($oldwpdtreeopt, COUNT_RECURSIVE) != count($newwpdtreeopt, COUNT_RECURSIVE)){		
			update_option('wp_dtree_options', $newwpdtreeopt);	//only update if the new options require new fields. (TODO: merge old settings with new ones...)
		}
	}
