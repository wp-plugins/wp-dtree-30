...
class WPDT_Taxonomies_Widget extends WPDT_Widget{	
	function __construct() {		
		$widget_ops = array('classname' => 'wpdt-taxonomies', 'description' => __('An experimental dTree for your custom taxonomies.', 'wpdtree') ); //widget settings. 
	...
	?>
		<p>
			...
			<label for="<?php echo $this->get_field_id('sortby'); ?>" title="<?php esc_attr_e('Sort taxonomies alphabetically or by unique taxonomy ID. The default is sort by taxonomy ID.','wpdtree');?>"><?php _e('Sort by:', 'wpdtree'); ?></label> 
			...
			<label for="<?php echo $this->get_field_id('number'); ?>" title="<?php esc_attr_e('Number of taxonomies to display. (0 to display all)','wpdtree');?>"><?php _e('Limit:', 'wpdtree'); ?></label>
			...
			<label for="<?php echo $this->get_field_id('limit_posts'); ?>" title="<?php esc_attr_e('Number of posts to display under each Taxonomy (0 to display all)','wpdtree');?>"><?php _e('Limit posts:', 'wpdtree'); ?></label>
			...
			<label for="<?php echo $this->get_field_id('more_link'); ?>" title="<?php esc_attr_e('Show link to additional taxonomy content. %excluded% is replaced with the remaining count.','wpdtree'); ?>"><?php esc_html_e('Show more link:', 'wpdtree'); ?></label>
		...
		?>		
			<label for="<?php echo $this->get_field_id('child_of'); ?>" title="<?php esc_attr_e('Display alltaxonomies that are descendants (i.e. children & grandchildren) of the Taxonomy.','wpdtree'); ?>"><?php _e('Show descendands of:', 'wpdtree'); ?></label> 
			...
			<label for="<?php echo $this->get_field_id('parent'); ?>" title="<?php esc_attr_e('Display only taxonomies that are direct descendants (i.e. children only) of the Taxonomy. This does NOT work like the \'child_of\' parameter.','wpdtree'); ?>"><?php _e('Only *direct* children of:', 'wpdtree'); ?></label> 			
